...
class ActualController extends Controller
{
    ...
    public function buscarActivos(Request $request){
        ...
        $actuales = Actual::join('oficina','actual.codofic','=','oficina.codofic')
        ->select('actual.id','actual.codigo','actual.codresp','actual.codofic',
        'oficina.nomofic','actual.descripcion','actual.codestado')
